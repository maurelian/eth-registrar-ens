...
// Registrar from https://raw.githubusercontent.com/ethereum/ens/1ce01f29d601f843ac308a015c327c702d224cc7/contracts/HashRegistrarSimplified.sol
...
contract Registrar {
     ...
     */
    function Registrar(ENS _ens, bytes32 _rootNode, uint _startDate) {
        ens = _ens;
        rootNode = _rootNode;
...
contract DeployENS {
    ...
    function DeployENS() {
        ...
        registrar = new Registrar(ens, tldnode, now);
